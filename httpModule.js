...
// maybe the internet should be off to run the program properly
...
const server = http.createServer((req, res) => { 
  if(req.url === "/") { //url property tells us what address client is requesting(what end point the client is requesting)(in this case the home page) becasue we are using one slash(/). wirte in google chrome localhost:5000 to see the result. you need to run this program every time to see the resutl of the different pages
